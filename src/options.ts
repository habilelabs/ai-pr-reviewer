...
export class Options {
  ...
  constructor(
    ...
    systemMessage = '',
    openaiLightModel = '2023-07-01-preview',
    openaiHeavyModel = '2023-07-01-preview',
    openaiModelTemperature = '0.0',
    openaiRetries = '3',
    openaiTimeoutMS = '120000',
    openaiConcurrencyLimit = '6',
    githubConcurrencyLimit = '6',
    apiBaseUrl = 'https://jhopenai8f.openai.azure.com/',
    language = 'en-US'
  ) {
    this.debug = debug
...
export class OpenAIOptions {
  ...
  constructor(model = '2023-07-01-preview', tokenLimits: TokenLimits | null = null) {
    this.model = model
    if (tokenLimits != null) {
