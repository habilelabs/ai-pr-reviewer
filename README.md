...
GitHub pull requests using OpenAI's `2023-07-01-preview` and `gpt-4` models. It is
...
- **"Light" model for summary**: Designed to be used with a "light"
  summarization model (e.g. `2023-07-01-preview`) and a "heavy" review model (e.g.
...
### Models: `gpt-4` and `2023-07-01-preview`

Recommend using `2023-07-01-preview` for lighter tasks such as summarizing the
changes (`openai_light_model` in configuration) and `gpt-4` for more complex
review and commenting tasks (`openai_heavy_model` in configuration).

Costs: `2023-07-01-preview` is dirt cheap. `gpt-4` is orders of magnitude more
